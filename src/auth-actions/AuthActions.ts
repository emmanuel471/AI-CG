...
export const forgotPassword = (email: string) => {
  return makeApiCall(
    `${API_ENDPOINTS.FORGOT_PASSWORD}?email=${encodeURIComponent(email)}`,
    "POST",
    null,
